class Post < ApplicationRecord
  ...
  validates :title, presence :true, message: "The post should have a title"
  validates :content, presence :true, message: "The post should have a content"
  validates :user_id, presence :true, message: "The post should belong to a user"
